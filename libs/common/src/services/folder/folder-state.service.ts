...
import { FolderStateService as FolderServiceAbstraction } from "../../abstractions/folder/folder-state.service.abstraction";
...
export class FolderStateService implements FolderServiceAbstraction {
  constructor(
