...
import { BulkRemoveComponent as OrganizationBulkRemoveComponent } from "src/app/modules/organizations/manage/bulk/bulk-remove.component";

@Component({
  templateUrl:
    "../../../../../../../apps/web/src/app/modules/organizations/manage/bulk/bulk-remove.component.html",
})
